            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= html_escape($aparelho["descricao"]) ?>
                                    </td>
                    ...
                    <td>
                      ...
                      data-target=".bs-example-modal-lg<?= $aparelho['id'] ?>"><i
                      class="fa fa-eye"></i></a>


                      <div class="modal fade bs-example-modal-lg<?= $aparelho['id'] ?>" id="modal"
                            ...
                            <div class="modal-content">
                                <button type="button" class="close" data-dismiss="modal"><i
                                    ...
                                    <div class="modal-header" style="border: none;">
                                        ...
                                        data-toggle="modal"
                                        data-target=".bs-example-modal-lg<?= $aparelho['id'] ?>"
